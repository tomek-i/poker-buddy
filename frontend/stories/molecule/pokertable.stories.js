...
import { PokerTable } from "../../src/components/molecule/pokertable";
...
storiesOf("Molecule/Poker/Table", module)
  .add("empty", () => <PokerTable></PokerTable>)
  .add("with cards", () => <PokerTable></PokerTable>)
  .add("with 2 players", () => (
  ...
  .add("with 8 players", () => (
    <PokerTable players={players.slice(0, 8)}></PokerTable>
  ));
